...
- Responsaveis pelo isolamentos de recursos (usuários, pontos de montagens etc..).
...
**etcd: Tem como função guardar todo o estado atual do Cluster. Roda sempre por padrão no control-plane**
...
São os agents dos control plane no kubernetes que são executados em nada worker.
Eles se comunicão direto com o API-SERVER do **K8S**.
